      ...
      <div className="glass-panel p-8 sm:p-12 rounded-[2.5rem] shadow-xl border border-brand-coral/20 relative overflow-hidden">
        ...
        <form className="space-y-8">
          ...
          <div className="pt-6 mt-6 border-t border-brand-text/10 flex justify-end">
            <button 
              type="button" 
              className="flex items-center gap-2 bg-brand-orange hover:bg-[#ff5c1a] text-brand-bg px-10 py-4 rounded-2xl font-bold text-lg transition-all shadow-[0_8px_20px_-6px_rgba(255,69,0,0.4)] hover:shadow-[0_12px_25px_-6px_rgba(255,69,0,0.5)] hover:-translate-y-0.5"
            >
